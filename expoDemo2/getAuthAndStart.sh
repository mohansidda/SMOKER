...
export SMOKER_TRUSTSTORE_PATH="/home/sknot/RH/SMOKER/expoDemo2/truststore.jks"
export SMOKER_KEYSTORE_PASSWORD="123456"
export SMOKER_KEYSTORE_PATH="/home/sknot/RH/SMOKER/expoDemo2/user.p12"
export SMOKER_TOPIC_USR1USR2="smoker_topic_usr2_2_usr1"
export SMOKER_TOPIC_USR2USR1="smoker_topic_usr1_2_usr2"
export SMOKER_GROUP_ID="my-group-3"
